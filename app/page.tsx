...
// ============================================================
// HERO - VERSÃO REPARADA (SEM ERROS DE DEPENDÊNCIA)
// ============================================================
const Hero = () => {
  const scrollToCatalog = () =>
    document.getElementById("catalog")?.scrollIntoView({ behavior: "smooth" });

  // Componente do Logo interno com a animação do pingo
  const LogoLHIT = () => (
    <div className="flex flex-col items-center justify-center select-none mb-12 md:mb-16 scale-125 md:scale-[1.5] origin-left">
      <div className="relative flex items-center justify-center gap-1 mb-[-4px]">
        ...
        <motion.span
          animate={{ scale: [1, 1.2, 1], opacity: [0.7, 1, 0.7], filter: ["drop-shadow(0 0 2px #DFFF00)", "drop-shadow(0 0 10px #DFFF00)"] }}
          transition={{ duration: 3, repeat: Infinity }}
          className="text-[#DFFF00] text-2xl mx-0.5"
        >✦</motion.span>
        <span className="text-3xl font-black text-white italic tracking-tighter">A</span>
      </div>
      <motion.div initial={{ width: 0 }} animate={{ width: "110%" }} transition={{ duration: 1, delay: 0.5 }} className="h-[1.5px] bg-[#00F0FF] shadow-[0_0_12px_#00F0FF] relative z-10" />
      <div className="flex items-center justify-center text-[10px] font-black text-[#DFFF00] tracking-[0.5em] mt-1 relative">
        ...
        <div className="relative inline-flex justify-center">
          ...
          <motion.div
            ...
            animate={{ y: -40, opacity: 0, scale: [1, 1.5, 0.5] }}
            transition={{ duration: 1.2, repeat: Infinity, repeatDelay: 2, ease: "circIn" }}
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-[#020617]">
      {/* Fallback caso o TerrainCanvas falhe: fundo escuro com glow */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,#0c1a35_0%,#020617_100%)]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-20">
        <div className="max-w-4xl mx-auto text-center md:text-left md:mx-0">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-5xl md:text-8xl font-black tracking-tighter text-white leading-[0.85] mb-8 uppercase">
              TRANSFORMANDO <br />
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <button
              ...
              className="px-10 py-5 bg-[#DFFF00] text-[#020617] font-black tracking-widest uppercase hover:brightness-110 transition-all shadow-[0_0_30px_rgba(223,255,0,0.3)] active:scale-95"
            >
              Explorar Catálogo
            </button>
            <button className="px-10 py-5 border border-[#00F0FF]/30 text-[#00F0FF] font-bold uppercase tracking-widest flex items-center gap-3 backdrop-blur-sm hover:bg-[#00F0FF]/10 transition-all">
      ...
      <div className="absolute bottom-10 right-10 text-[#00F0FF] font-mono text-[10px] opacity-40 flex flex-col items-end gap-1 tracking-widest">
