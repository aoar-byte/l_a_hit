          ...
          <div className="max-w-4xl lg:max-w-5xl">
            ...
            >
              <MagneticButton
                ...
                className="px-3 sm:px-8 py-1 bg-[#00F0FF] text-[#020617] font-black tracking-widest uppercase text-sm sm:text-base shadow-[0_0_25px_rgba(0,240,255,0.5)] hover:shadow-[0_0_35px_rgba(0,240,255,0.7)] transition-all"
              >
                Explorar Catálogo
              </MagneticButton>
              ...
              <MagneticButton
                ...
                className="px-1 sm:px-8 py-3 border border-white/20 text-white font-bold uppercase tracking-widest text-sm sm:text-base flex items-center gap-2 sm:gap-3 backdrop-blur-sm hover:border-[#DFFF00] hover:text-[#DFFF00] hover:shadow-[0_0_20px_rgba(223,255,0,0.3)] transition-all group"
              >
